...
public class AgencyAccountPage extends PageObject {
    ...
    public ArrayList<String> agencyAccountPageContainsNecessaryElements(List<String> list) {
        ...
        commonActions.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='components-name' and contains(text(),'Agency details')])[1]")));
...
//                !getDriver().findElement(By.xpath("(//div[@class='components-name' and contains(text(),'Account')])[1]")).isDisplayed() ) {
            ...
            commonActions.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(.,'Enter your agency name')]")));
