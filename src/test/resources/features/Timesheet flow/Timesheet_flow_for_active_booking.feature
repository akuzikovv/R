Feature:  Timesheet flow for active booking
  ...
  Scenario: Approving timesheet by teacher and school by API
    ...
    When Back to the first tab
#    When Open "https://www.guerrillamail.com/" in  the new tab
#    When Enter "newuatschool501" email of appropriate teacher
#    When Choose appropriate email message "Your timesheet has been approved"
#    Then Email body contains necessary text "Your timesheet has been approved by Horn Park Primary School123. Your payment can now be authorised.RealiseMe Team"
#    When Back to the first tab
#    When Click on the arrow down button
#    When Click on the LOGOUT button
